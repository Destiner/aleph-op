...
type MethodType = 'standard' | 'debug' | 'trace' | 'optimism';
...
const OPTIMISM_OUTPUT_AT_BLOCK = 'optimism_outputAtBlock';
const OPTIMISM_SYNC_STATUS = 'optimism_syncStatus';
const OPTIMISM_ROLLUP_CONFIG = 'optimism_rollupConfig';
const OPTIMISM_VERSION = 'optimism_version';
...
type MethodId =
  ...
  | typeof OPTIMISM_OUTPUT_AT_BLOCK
  | typeof OPTIMISM_SYNC_STATUS
  | typeof OPTIMISM_ROLLUP_CONFIG
  | typeof OPTIMISM_VERSION;
